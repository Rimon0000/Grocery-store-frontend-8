...
const ProductDetails = async ({params} : TProductId) => {
  const res = await fetch(
    `https://grocery-store-server-red.vercel.app/single-fish/${params.productId}`
  );
  ...
  return (
    <div className="w-[90%] mx-auto">
      <h1 className="flex mt-5">
        product Listing <ChevronRight /> Product Details{" "}
      </h1>
